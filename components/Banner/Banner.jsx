...
const Banner = ({ name, childStyles, parentStyle }) => {
  ...
  return(
    ...
    <div className={`relative w-full flex items-center overflow-hidden ${parentStyle}`}> 
      ...
      <Button  btnName="Book" classStyles="absolute focus:ring bottom-10 sm:pt-1 sm:pb-1 md:bottom-3 lg:bottom-3 rounded-full items-center justify-center cursor-pointer " handleClick={() => router.push('http://platinumbladesformen.booksy.com/')} />
    </div>
